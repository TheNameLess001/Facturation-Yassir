...
class ReviewIssueType(StrEnum):
    ...
    RIB_CHANGED_AFTER_BATCH = "RIB_CHANGED_AFTER_BATCH"
    ...
    EMAIL_PACKAGE_INCOMPLETE = "EMAIL_PACKAGE_INCOMPLETE"
    EMAIL_DOCUMENT_STALE = "EMAIL_DOCUMENT_STALE"
    EMAIL_PROVIDER_FAILED = "EMAIL_PROVIDER_FAILED"
    EMAIL_AUTHORIZATION_STALE = "EMAIL_AUTHORIZATION_STALE"
